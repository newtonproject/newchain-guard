...
func TestReverseProxy(t *testing.T) {
	...
	proxyHandler.ErrorLog = log.New() //  log.New(ioutil.Discard, "", 0) // quiet for tests
...
func TestReverseProxyCancelation(t *testing.T) {
	...
	proxyHandler.ErrorLog = log.New() // log.New(ioutil.Discard, "", 0)
...
func TestReverseProxyModifyResponse(t *testing.T) {
	...
	rproxy.ErrorLog = log.New() // log.New(ioutil.Discard, "", 0) // quiet for tests
...
func TestReverseProxy_CopyBuffer(t *testing.T) {
	...
	rproxy := NewSingleHostReverseProxy(rpURL)
	rproxy.ErrorLog = log.New() // log.New(&proxyLog, "", log.Lshortfile)
	frontendProxy := httptest.NewServer(rproxy)
	defer frontendProxy.Close()
...
func TestModifyResponseClosesBody(t *testing.T) {
	...
	rp := &ReverseProxy{
		...
		ErrorLog: log.New(), // log.New(logBuf, "", 0),
